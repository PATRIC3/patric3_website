...
*/
	...
	genomeStatusClickHandler = function(d, i, meta) {
		if (d.label == "Whole Genome Shotgun") {
			...
			window.location = "/portal/portal/patric/GenomeList?cType=taxon&cId=2&dataSource=&displayMode=&pk=&kw=genome_status:WGS";
		}
			...
			window.location = "/portal/portal/patric/GenomeList?cType=taxon&cId=2&dataSource=&displayMode=&pk=&kw=genome_status:Complete";
		}
		else {
			...
			window.location = "/portal/portal/patric/GenomeList?cType=taxon&cId=2&dataSource=&displayMode=&pk=&kw=genome_status:Plasmid"
		}
	};
	...
	numberOfBacterialGenomesClickHandler = function(d, i, meta) {
		...
		window.location = "/portal/portal/patric/GenomeList?cType=taxon&cId=2&dataSource=&displayMode=&pk=&kw="+kw
	};
	...
	top5HostClickHandler = function(d, i, meta) {
		...
		window.location = '/portal/portal/patric/GenomeList?cType=taxon&cId=2&dataSource=&displayMode=&pk=&kw=host_name:'+encodeURIComponent('"'+d.label+'"');
	};
	...
	top5IsolationCountryClickHandler = function(d, i, meta) {
		...
		window.location = '/portal/portal/patric/GenomeList?cType=taxon&cId=2&dataSource=&displayMode=&pk=&kw=isolation_country:'+encodeURIComponent('"'+d.label+'"');
	};
