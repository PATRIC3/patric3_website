...
public class ToolList extends GenericPortlet {
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, IOException {
		...
		URL jsonURL = new URL("http://enews.patricbrc.org/tool_landing/tool-landing-page-1/?req=passphrase");
		...
		try {
			...
			try {
				jsonResult.put("tools", (JSONObject) new JSONParser().parse(json_builder.toString()));
			}
			catch (Exception e) {
			}
		}
