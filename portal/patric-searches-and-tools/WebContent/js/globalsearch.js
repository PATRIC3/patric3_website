...
function saveToPK() {
	var Page = $Page, property = Page.getPageProperties(), hash = property.hash, keyword = Ext.getDom("keyword").value;
	if (property.name[hash.cat] == "Feature") {
	    keyword += " AND !(feature_type:source)";
	}
	Ext.Ajax.request({
