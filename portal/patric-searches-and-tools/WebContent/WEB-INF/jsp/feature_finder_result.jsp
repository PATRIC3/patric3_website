...
Ext.onReady(function()
{
	...
	var pageProperties = {
		...
		scm:[[checkbox, 
			...
			{header:'PATRIC Local Family',	dataIndex:'plfam_id',			orig_hidden_value: true, hidden:true, flex:1, align:'center', renderer:BasicRenderer},
			{header:'PATRIC Global Family',	dataIndex:'pgfam_id',			orig_hidden_value: true, hidden:true, flex:1, align:'center', renderer:BasicRenderer},
