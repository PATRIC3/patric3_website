...
%>
	...
	The Gene Ontology (GO) project, part of a major bioinformatics initiative, provides an ontology of defined terms representing gene product properties.
	  The GO Search tool enables researchers to locate proteins annotated with specified GO criteria.
	  For further explanation, please see <a href="//enews.patricbrc.org/go-search-faqs/" target="_blank">GO Search FAQs</a>.
	</p></div>
