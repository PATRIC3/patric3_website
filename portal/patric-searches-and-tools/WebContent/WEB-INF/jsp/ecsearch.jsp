...
%>
	...
	<div id="intro" class="searchtool-intro">
		<p>The Enzyme Commission (EC) number is a numerical classification scheme for enzymes based on the chemical reactions they catalyze.
		  The EC Search tool enables researchers to locate proteins annotated with specified EC criteria.
		  For further explanation, please see <a href="//enews.patricbrc.org/ec-search-faqs/" target="_blank">EC Search FAQs</a>.</p>
	</div>
