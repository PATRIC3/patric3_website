...
Ext.onReady(function() {
	...
	var pageProperties = {
		...
		url: ['/portal/portal/patric/AntibioticResistanceGeneSearch/AntibioticResistanceGeneSearchWindow?action=b&cacheability=PAGE'],
...
function getOriginalKeyword(hash){
	...
	return constructKeyword(obj_, "AntibioticResistanceGeneMapping");
}
