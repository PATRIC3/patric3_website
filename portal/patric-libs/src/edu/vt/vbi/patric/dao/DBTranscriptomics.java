...
*/
	...
	public String getPathwayEnrichmentSQL(Map<String, String> key, String where) {
	...
	public String getParsedFeatureIds(Map<String, String> key) {
	...
	public List<ResultType> getPathwayEnrichmentList(Map<String, String> key, Map<String, String> sort, int start, int end) {
