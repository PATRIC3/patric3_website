...
public class DBPathways {
	...
	public List<ResultType> getPathwayList(Map<String, String> key, Map<String, String> sort, int start, int end) {

		return getFeaturePathwayList(key, sort, start, end);
	}

	public String getPathwaySQL(Map<String, String> key) {
	...
	public List<ResultType> getFeaturePathwayList(Map<String, String> key, Map<String, String> sort, int start, int end) {
	...
	public String CompleteGenomeSQL(Map<?, ?> key) {
	...
	public SQLQuery bindCompSQLValues(SQLQuery q, Map<?, ?> key) {
	...
	public String CompSQLConditions(Map<?, ?> key) {
	...
	public String getCompPathwayPathwaySQL(Map<String, String> key, String where) {
	...
	public List<ResultType> getCompPathwayPathwayList(Map<String, String> key, Map<String, String> sort, int start, int end) {
	...
	public String getCompPathwayECSQL(Map<String, String> key, String where) {
	...
	public List<ResultType> getCompPathwayECList(Map<String, String> key, Map<String, String> sort, int start, int end) {
		String sql = "";
	...
	public String getCompPathwayFeatureSQL(Map<String, String> key, String where) {
	...
	public List<ResultType> getCompPathwayFeatureList(Map<String, String> key, Map<String, String> sort, int start, int end) {
		...
		if (key.containsKey("which") && key.get("which").equals("download_from_heatmap_feature")) {
			...
			key_clone = (HashMap<String, String>) ((HashMap<String, String>) key).clone();
	...
	public ArrayList<Integer> getDistECConservation(String cType, String cId) {
		...
		String sql = "select bin, count(*) cnt from ( "
				...
				+ "		where ps.genome_info_id = gs.genome_info_id AND ps.algorithm = 'RAST' "
