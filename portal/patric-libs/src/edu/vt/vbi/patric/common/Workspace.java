...
public class Workspace {
	...
	public Set<Integer> addTracks(String type, String internalIds) {

		HashSet<Object> hsInternalIds = new HashSet<>();
	...
	public void addMapping(int tagId, Set<Integer> trackIds) {
	...
	public void removeTracks(Set<Integer> trackIds) {
	...
	public void removeTags(Set<Integer> tagIds) {
	...
	public void removeMapping(Set<Integer> tagIds, Set<Integer> trackIds) {
	...
	public JSONArray getTracks(Set<Integer> trackIds) {
		JSONArray rtn = new JSONArray();
	...
	public JSONArray getTracks(JSONObject filters) {
		...
		if (tracks != null && tracks.size() > 0) {
			if (filters.containsKey("key") && filters.containsKey("value")) {
				...
				for (Object track : tracks) {
					JSONObject jsonTrack = (JSONObject) track;
					if (jsonTrack.containsKey(k) && hash.contains(jsonTrack.get(k).toString())) { // pass filters
						rtn.add(jsonTrack);
					}
				}
			}
