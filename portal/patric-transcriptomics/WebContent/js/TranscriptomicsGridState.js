	...
	if ((this.serveURL != null) && ((this.master).allowHashing)) {++this.steps;
		...
		Ext.Ajax.request({
			...
			params : {
				...
				ClusterRowOrder : (this.ClusterRowOrder!=undefined)?this.ClusterRowOrder.join(";"):"",
				ClusterColumnOrder : (this.ClusterColumnOrder!=undefined)?this.ClusterColumnOrder.join(";"):"",
