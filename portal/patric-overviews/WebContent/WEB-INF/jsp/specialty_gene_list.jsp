...
For more details, see <a href="http://enews.patricbrc.org/faqs/genome-feature-data-and-tools/specialty-genes-faqs/" target="_blank">Specialty Genes User Guide</a>.</p>
...
Ext.onReady(function () {
	...
	var pageProperties = {
		...
		scm: [[checkbox,
			...
			{header:'PATRIC ID',	       	dataIndex:'patric_id',       		flex:2, renderer:renderSeedId, align:'center'},
