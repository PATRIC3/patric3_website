...
<% if (source.equals("PATRIC_VF")) { %>
	<p>PATRIC_VF is a manually curated virulence factor database, which contains the genes identified as playing a role in 
		...
		virulence based on experimental evidence. For more details, please see <a href="//enews.patricbrc.org/faqs/patric-curated-virulence-factors-faqs/" target="_blank">FAQs</a>.</p>
<% } else { %>
