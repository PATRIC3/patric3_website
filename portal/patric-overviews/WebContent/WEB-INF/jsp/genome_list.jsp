...
Ext.onReady(function () {
	...
	var pageProperties = {
		...
		scm: [[checkbox,
			...
			{header:'BioProject Accession', dataIndex:'bioproject_accession',	flex:1, align:'center', hidden:true, renderer:renderBioProjectAccession},
			{header:'BioSample Accession',  dataIndex:'biosample_accession',	flex:1, align:'center', hidden:true, renderer:renderBioSampleAccession},
			{header:'Assembly Accession', 	dataIndex:'assembly_accession',	flex:1, align:'center', hidden:true, renderer:renderAssemblyAccession},
