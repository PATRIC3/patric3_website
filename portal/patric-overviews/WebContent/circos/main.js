...
function loadCircosMap(conf) {
  Ext.Ajax.request({
            url: '/patric-overviews/images/' + conf.imageId + '/circos.html',
            success: function(rs) {
              ...
              graph.innerHTML = rs.responseText
                      ...
                      + conf.trackList
                      + '</span></div><button class="button" onclick="saveImage()">Download Image</button><div class="clear"></div><img src="/patric-overviews/images/'
...
function createPopup(feature) {
  var strFeature = Ext.String.format("{0}{1}{2}", feature.locus_tag, (feature.refseq_locus_tag != null ? " | " + feature.refseq_locus_tag : ""),
  ...
  var linkGB = Ext.String.format("GenomeBrowser?cType=feature&cId={0}&loc={1}..{2}&tracks=DNA,PATRICGenes", feature.na_feature_id, feature.start_max,
          feature.end_min);
