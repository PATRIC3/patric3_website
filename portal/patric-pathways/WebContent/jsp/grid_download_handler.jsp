...
<%
	...
	if (_tablesource.equalsIgnoreCase("PathwayTable")) {
		...
		if (request.getParameter("aT").equals("0")) {
			_tbl_source = conn_pathways.getCompPathwayPathwayList(key, sort, 0, -1);
			...
			_tbl_source =  conn_pathways.getCompPathwayECList(key, sort, 0, -1);
			...
			_tbl_header.addAll(Arrays.asList("Feature ID", "Genome Name", "Accession", "Locus Tag", "Gene Symbol", "Product Name",
					"Annotation", "Pathway ID", "Pathway Name", "Ec Number", "EC Description"));
			_tbl_field.addAll(Arrays.asList("na_deature_id", "genome_name", "accession", "locus_tag", "gene", "product", "algorithm",
		...
		if (request.getParameter("aT").equals("0")) {
			...
			_tbl_source = conn_pathways.getCompPathwayECList((HashMap<String, String>) key, sort, 0, -1);
			if (cType.equals("taxon")) {
				_tbl_header.addAll(Arrays.asList("Pathway ID", "Pathway Name", "Pathway Class", "Annotation", "EC Number", "EC Description",
						"Genome Count", "Unique Gene Count"));
				_tbl_field.addAll(Arrays.asList("pathway_id", "pathway_name", "pathway_class", "algorithm", "ec_number", "ec_name",
			...
			_tbl_source = conn_pathways.getCompPathwayFeatureList((HashMap<String, String>) key, sort, 0, -1);
			_tbl_header.addAll(Arrays.asList("Feature ID", "Genome Name", "Accession", "Locus Tag", "Gene Symbol", "Product Name",
					"Annotation", "Pathway ID", "Pathway Name", "Ec Number", "EC Description"));
			_tbl_field.addAll(Arrays.asList("na_feature_id", "genome_name", "accession", "locus_tag", "gene", "product", "algorithm",
					"pathway_id", "pathway_name", "ec_number", "ec_name"));
		}
