...
import edu.vt.vbi.patric.mashup.xmlHandler.ESearchHandler;
import edu.vt.vbi.patric.mashup.xmlHandler.GEOHandler;
import edu.vt.vbi.patric.mashup.xmlHandler.PeptidomeHandler;
import edu.vt.vbi.patric.mashup.xmlHandler.PubMedHandler;
import edu.vt.vbi.patric.mashup.xmlHandler.StructureHandler;
...
public class EutilInterface {
	...
	public Map<String, String> getCounts(String db, String term, String search_opt) throws java.rmi.RemoteException, SocketTimeoutException,
