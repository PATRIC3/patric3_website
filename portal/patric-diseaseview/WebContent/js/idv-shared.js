var patricSvr = "http://callisto.bioinformatics.vt.edu/";
var patricDir = { docs: patricSvr + "patric/", 
									libs: patricSvr + "patric/libs/", 
									cgi : patricSvr + "cgi-bin/patric/" };
...
/**
	...
	* 	patric-id: patric na feature id
...
String.xref = function(str) {
	...
	switch (db[0]) {
		case "patric" : 
			switch (db[1]) {
				case "id" : 
					url = "/portal/portal/patric/Feature?cType=feature&amp;cId=" + term;
					break;
			}
			break;
		case "pubmed" : 
		...
		case "tax" : 
			switch (db[1]) {
				case "id" : 
					url = "/portal/portal/patric/Taxon?cType=taxon&cId=" + 
								term;
					break;
				case "name" : 
		...
		case "vfdb" : 
			switch (db[1]) {
				case "id" : 
					url = "http://www.mgc.ac.cn/cgi-bin/VFs/vfs.cgi?VFID=" + term;
					break;
				case "gid" : 
					url = "http://www.mgc.ac.cn/cgi-bin/VFs/gene.cgi?GeneID=" + term;
					break;
			}
			break;
	}
