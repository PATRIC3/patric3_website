...
if (!this.edu.vt.vbi.patric.network)	{ this.edu.vt.vbi.patric.network = {}; }


edu.vt.vbi.patric.network.IDVGraph = function (options) {
	this.graphid;							// the seed taxon id
	this.cygraph;
	this.mtl;
		...
		nodes  : { styles : {
								...
								labelXOffset: {
									 ...
									 discreteMapper: {
										 attrName: "role", 
										 entries: [ 
											 {attrValue: "virulence gene", value: -2}, 
											 {attrValue: "host gene", value: -2}, 
											 {attrValue: "collection:virulence gene", value: -2}, 
											 {attrValue: "collection:host gene", value: -2} 
										 ] 
									 }
								 }, 
								labelFontColor: {
									 ...
									 discreteMapper: {
										 attrName: "role", 
										 entries: [ 
											 {attrValue: "virulence gene", value: "#333333"}, 
											 {attrValue: "host gene", value: "#333333"}, 
											 {attrValue: "collection:virulence gene", value: "#333333"}, 
											 {attrValue: "collection:host gene", value: "#333333"} 
										 ] 
									 }
								 }, 
								labelFontStyle: {
									 ...
									 discreteMapper: {
										 ...
										 entries: [ 
											 ...
											 {attrValue: "host gene", value: "italic"}, 
											 {attrValue: "virulence gene", value: "italic"} 
										 ] 
									 }
								 }, 
								labelFontWeight: {
									 ...
									 discreteMapper: {
										 ...
										 entries: [ 
											 ...
											 {attrValue: "virulence gene", value: "normal"}, 
											 {attrValue: "host gene", value: "normal"}, 
											 {attrValue: "collection:virulence gene", value: "normal"}, 
											 {attrValue: "collection:host gene", value: "normal"} 
										 ] 
									 }
								 }, 
								labelFontSize: {
									 ...
									 discreteMapper: {
										 ...
										 entries: [ 
											 ...
											 {attrValue: "virulence gene", value: 9}, 
											 {attrValue: "host gene", value: 9}, 
											 {attrValue: "collection:virulence gene", value: 9}, 
											 {attrValue: "collection:host gene", value: 9} 
										 ] 
									 }
								 }, 
								opacity: {
									 ...
									 discreteMapper: {
										 attrName: "role", 
										 entries: [ 
											 {attrValue: "virulence gene", value: 0.7}, 
											 {attrValue: "host gene", value: 0.7}, 
											 {attrValue: "collection:virulence gene", value: 0.7}, 
											 {attrValue: "collection:host gene", value: 0.7} 
										 ] 
									 }
								 }, 
								size: { 
									 ...
									 discreteMapper: {
										 ...
										 entries: [ 
											 ...
											 {attrValue: "host gene", value: 12}, 
											 {attrValue: "collection:host gene", value: 9}, 
											 {attrValue: "virulence gene", value: 12}, 
											 {attrValue: "collection:virulence gene", value: 9} 
										 ] 
									 } 
								}, 
								shape: { 
									 ...
									 discreteMapper: {
										 ...
										 entries: [ 
											 ...
											 {attrValue: "host gene", value: "ELLIPSE"}, 
											 {attrValue: "collection:host gene", value: "ELLIPSE"}, 
											 {attrValue: "virulence gene", value: "ELLIPSE"}, 
											 {attrValue: "collection:virulence gene", value: "ELLIPSE"} 
										 ] 
									 } 
								 }, 
								color: { 
									 ...
									 discreteMapper: {
										 attrName: "role", 
										 entries: [ 
											 {attrValue: "disease", value: "#1EA2C3"}, 
											 {attrValue: "pathogen", value: "#cc66ff"}, 
											 {attrValue: "collection:pathogen", value: "#cc66ff"}, 
											 {attrValue: "host gene", value: "#008000"}, 
											 {attrValue: "collection:host gene", value: "#008000"}, 
											 {attrValue: "virulence gene", value: "#FF5E5B"}, 
											 {attrValue: "collection:virulence gene", value: "#FF5E5B"} 
										 ] 
									 } 
								 }, 
								borderColor: { 
								...
								borderWidth: { 
									 ...
									 discreteMapper: {
										 ...
										 entries: [ 
											 ...
											 {attrValue: "collection:host gene", value: 10}, 
											 {attrValue: "collection:virulence gene", value: 10} 
										 ] 
									 } 
								 }, 
		...
		edges  : { styles : { 
								...
								color: {
									 ...
									 discreteMapper: {
										 attrName: "role", 
										 entries: [ 
											 {attrValue: "hierarchy:disease", value: "#45B9D3"}, 
											 {attrValue: "hierarchy:taxonomy", value: "#DB94FF"}, 
											 {attrValue: "association:pathogen-disease", value: "#d0d0d0"}, 
											 {attrValue: "association:host gene-disease", value: "#c3ffc3"}, 
											 {attrValue: "association:pathogen-virulence gene", value: "#FFACA3"} 
										 ] 
									 }
								 }, 
								sourceArrowColor: { 
	...
	**/
	...
	this.ready = function () {
		...
		if (!this.mtl) {
			this.mtl = new edu.vt.vbi.patric.network.MirroredTreeLayout({ 
										graph: this, 
										trees: { prop: "role", 
														 valA: ["disease"], 
	...
	**/
	...
	this.getCoords = function(elem) {
					if (elem.data && elem.data.source && elem.data.target) {
									return this.getEdgeCoords(elem);
					} else {
									return this.getNodeCoords(elem);
					}
		};
		
		this.getNodeCoords = function(node) {
						var coords = { x: 0, y: 0 };
						if (node && node.x) { coords.x = node.x; }
						if (node && node.y) { coords.y = node.y; }
						return coords;
		};
		
		this.getEdgeCoords = function(edge) {
						var coords = { x: 0, y: 0 };
						if (edge && edge.data.source && edge.data.target) {
										var s = this.getNode(edge.data.source);
										var t = this.getNode(edge.data.target);
										coords.x = parseInt(Math.abs(s.x + t.x)/2);
										coords.y = parseInt(Math.abs(s.y + t.y)/2);
						}
						return coords;
		};
	...
	*/
		...
		content += 
			"<tr class=\"row\">" + 
				"<td class=\"note\" colspan=\"2\">" + 
					"This node represent a nonspecific group of <i>" + parent + "<\/i> species, " + 
	...
	this.getDiseaseInfo = function (node, domclass) {
		...
		content += 
			"<tr class=\"row-alt\">" + 
				"<td class=\"label\">Chemically-associated genes:<\/td>" + 
				"<td class=\"value\">";
		if (counts["dahgs-ctd"][0] > 0) {
			content += 
					"<a href=\"" + this.buildDAHGCurl(this.graphid, "taxon", "ctd", node.data.uid) + "\">" + 
					counts["dahgs-ctd"][0] +
					"<\/a>";
		} else {
		...
		content += 
			"<tr class=\"row\">" + 
				"<td class=\"label\">Genetically-associated genes:<\/td>" + 
				"<td class=\"value\">";
		if (counts["dahgs-gad"][0] > 0) {
			content += 
					"<a href=\"" + this.buildDAHGCurl(this.graphid, "taxon", "gad", node.data.name) + "\">" + 
					counts["dahgs-gad"][0] +
					"<\/a>";
		} else {
	...
	this.getPAVFInfo = function (node, domclass) {
		...
		content += 
			"<tr class=\"row-alt\">" + 
				...
				"<td class=\"value\">" + 
					"<a href=\"" + String.xref("tax-id:" + xrefs["tax-id"][0]) + "\"><i>" + 
						this.getTerms(node.data.groups, "tax-name")["tax-name"][0] + 
					"<\/i><\/a>" + 
				"<\/td>" + 
			"<\/tr>";
		// add xrefs
		if (xrefs["vfdb-id"] || xrefs["vfdb-gid"]) {
			content += "<tr class=\"row\"><td class=\"label\">More info:<\/td>" + 
								 "<td class=\"value\">";
			if (xrefs["vfdb-gid"]) {
				content += 
					"VF gene: " + 
					"<a href=\"" + String.xref("vfdb-gid:" + xrefs["vfdb-gid"][0]) + 
					"\">" + xrefs["vfdb-gid"][0] +  "<\/a>";
			}
			if (xrefs["vfdb-id"]) {
				if (xrefs["vfdb-gid"]) { content += "<br \/>"; }
				content += 
					"VF factor: " + 
					"<a href=\"" + String.xref("vfdb-id:" + xrefs["vfdb-id"][0]) + 
					"\">" + xrefs["vfdb-id"][0] +  "<\/a>";
			}
			content += "<\/td><\/tr>";
		}
	...
	this.getPAVFCollInfo = function (node, domclass) {
		...
		var xrefs = this.getTerms(node.data.xrefs);
		var taxon_type = "taxon";
		var nbrIDs = this.getNeighborIDs(node.data.id);
		for (var i=0; i<nbrIDs.length; i++) {
			var nbrNode = this.getNode(nbrIDs[i]);
			if (nbrNode && nbrNode.data && nbrNode.data.rank && nbrNode.data.rank > 15) {
				taxon_type = "genome";
			}
		}
		var content = "";//this.getInfoHeader(node.data.label, domclass);
		...
		content += 
			"<tr class=\"row-alt\">" + 
				"<td class=\"label\">Curated virulence genes:<\/td>" + 
				"<td class=\"value\">";
		if (count > 0) {
			content += 
					"<a href=\"" + this.buildPAVFCurl(xrefs["tax-id"][0], taxon_type) + "\">" + 
					count +
					"<\/a>";
		} else {
			content += count;
	...
	this.getDAHGCollInfo = function (node, domclass) {
		...
		content += 
			"<tr class=\"row\">" + 
				"<td class=\"label\">Chemically-associated genes:<\/td>" + 
				"<td class=\"value\">" + counts["dahgs-ctd"][0] + "<\/td><\/tr>";
		content += 
			"<tr class=\"row\">" + 
				"<td class=\"label\">Genetically-associated genes:<\/td>" + 
				"<td class=\"value\">" + counts["dahgs-gad"][0] + "<\/td><\/tr>";
		// add xrefs
		/*
		var xrefs = node.data.xrefs.split("|");
		if (xrefs.length > 0) {
		...
		content += 
			"<tr class=\"row-alt\">" + 
				"<td class=\"note\" colspan=\"2\">" + 
					...
					"<a href=\"" + this.buildDAHGCurl(9606, "genome", "all", disease) + "\">here<\/a>." + 
				"<\/td>" + 
			"<\/tr>";
		*/
		content += "<\/table>";
	...
	this.buildPAVFCurl = function (tax_id, taxon_type) {
		return "DiseaseTable?cType=taxon&amp;cId="+tax_id+"&amp;type=vfdb";
	};
	
	this.buildDAHGCurl = function (tax_id, taxon_type, type, disease) {
		if (type == "ctd") {
			return "DiseaseTable?cType=taxon&amp;cId="+tax_id+"&amp;name="+disease+"&amp;type=ctdgraph";
		} else {
			return "DiseaseTable?cType=taxon&amp;cId="+tax_id+"&amp;name="+disease+"&amp;type=gadgraph";
		}
	};
	...
	this.filterDecorators = function(toHide) {
		...
		switch (toHide) {
			case "hg"  : 
				...
				this.layouts.mt = this.mtl.getLayoutCW();
				this.cygraph.layout(this.layouts.mt);
				var hide = [ { prop: "role", val: "host gene" }, 
										 { prop: "role", val: "collection:host gene" } ];
			...
			case "vf"  : 
				...
				this.layouts.mt = this.mtl.getLayoutCW();
				this.cygraph.layout(this.layouts.mt);
				var hide = [ { prop: "role", val: "virulence gene" }, 
										 { prop: "role", val: "collection:virulence gene" } ];
				filter = { group: "nodes", hide : hide };
...
/**
	...
	*						}
*/
edu.vt.vbi.patric.network.MirroredTreeLayout = function (options) {
