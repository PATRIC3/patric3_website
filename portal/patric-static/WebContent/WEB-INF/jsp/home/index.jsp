<script type="text/javascript" src="/patric/static/bacteriacloud_data.js"></script>
...
<div class="container main-container">
	<section class="main" role="main">
		<section class="two-thirds-col">
			<div class="column">
				<article id="dlp-hp">
					<h2 class="wp-headline section-title section-title-b">Browse Data</h2>
					<ul class="no-decoration no-underline-links">
						<li><figure><a href="Genomes"><img src="/patric/images/dlp-hp-genomes.png" alt="Genomes"></a>
							<figcaption>GENOMES</figcaption>
						</figure></li>
						<li><figure><a href="GenomicFeatures"><img src="/patric/images/dlp-hp-features.png" alt="Genomic Features"></a>
							<figcaption>GENOMIC FEATURES</figcaption>
						</figure></li>
						<li><figure><a href="SpecialtyGenes"><img src="/patric/images/dlp-hp-specialtygenes.png" alt="Specialty Genes"></a>
							<figcaption>SPECIALTY GENES</figcaption>
						</figure></li>
						<li><figure><a href="ProteinFamilies"><img src="/patric/images/dlp-hp-proteins.png" alt="Protein Families"></a>
							<figcaption>PROTEIN FAMILIES</figcaption>
						</figure></li>
						<li><figure><a href="Pathways"><img src="/patric/images/dlp-hp-pathways.png" alt="Pathways"></a>
							<figcaption>PATHWAYS</figcaption>
						</figure></li>
						<li><figure><a href="Transcriptomics"><img src="/patric/images/dlp-hp-transcriptomics.png" alt="Transcriptomic Experiments"></a>
			...
			<div class="column has-border">
				<div class="wrapper">
					<form>
						...
						<textarea id="blastKeyword" class="close2x tall full no-border" placeholder="Enter your Sequence"></textarea>
