...
<%
	String genomedataurl = "http://" + request.getServerName() + ":" + request.getServerPort() + "/patric-common/data/specialtygenes.json";
		...
		<div class="data-tab" id="tab1">
			...
			<div class="data-box" id="dlp-features-data">
				...
				<div class="data-box">
					...
					<p>Antibiotic Resistance refers to the ability of bacteria to develop resistance to antibiotics through gene mutation 
					or acquisition of antibiotic resistance genes. We have integrated and mapped known antibiotic resistance genes from the following sources:</p>
					<ul>
						<li><a href="<%=SiteHelper.getExternalLinks("ARDB_HOME") %>" target="_blank">ARDB</a></li>
						<li><a href="<%=SiteHelper.getExternalLinks("CARD_HOME") %>" target="_blank">CARD</a></li>
					</ul>
				</div>
				<div class="data-box">
					<h4>Drug Targets:</h4>
					<p>Drug Targets refer to the proteins being targeted by known/approved/experimental small molecule drugs. 
					We have integrated and mapped such drug targets from the following sources:</p>
					<ul>
						<li><a href="<%=SiteHelper.getExternalLinks("DrugBank_HOME") %>" target="_blank">DrugBank</a></li>
						<li><a href="<%=SiteHelper.getExternalLinks("TTD_HOME") %>" target="_blank">TTD</a></li>
					</ul>
				</div>
				<div class="data-box">
					<h4>Human Homologs:</h4>
					<p>Human Homologs refer to the bacterial proteins that share high sequence similarity with human proteins. 
					We have integrated and mapped proteins from <a href="<%=SiteHelper.getExternalLinks("Human_HOME") %>" target="_blank">Reference Human Genome at NCBI</a>.</p>
				</div>
				<div class="data-box">
					...
					<ul>
						<li><a href="<%=SiteHelper.getExternalLinks("PATRIC_VF_HOME") %>" target="_blank">PATRIC_VF</a></li>
						<li><a href="<%=SiteHelper.getExternalLinks("VFDB_HOME") %>" target="_blank">VFDB</a></li>
						<li><a href="<%=SiteHelper.getExternalLinks("Victors_HOME") %>" target="_blank">Victors</a></li>
					</ul>
				</div>
				<div class="clear"></div>
			</div>
