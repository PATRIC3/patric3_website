...
<%
	String genomedataurl = "http://" + request.getServerName() + ":" + request.getServerPort() + "/patric-common/data/ppinteractions.json";
...
<section class='sans-alternate workflow-title no-border letters-wider'>
	<div class='container'>
		<h1 class='upper down'>Protein Protein Interactions</h1>
	</div>
</section>
--%>
