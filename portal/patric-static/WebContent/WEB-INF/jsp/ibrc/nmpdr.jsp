...
<div id="fp">
	...
	<div class="left" style="width:38%">
		...
		<p>You may have reached this page while looking for the National Microbial Pathogen Data Resource (NMPDR) BRC at www.nmpdr.org.  The Bioinformatics Resource Centers (BRCs) for Infectious Diseases program is a continuation and expansion of a program initiated in 2004 and consists of four new centers, each specializing in a different group of pathogens.  The PATRIC BRC is now responsible for all bacterial species in the NIAID <a href="//www3.niaid.nih.gov/topics/emerging/list.htm" target="_blank">Category A-C Priority Pathogen lists for biodefense research, and pathogens causing emerging/reemerging infectious diseases</a>.
		</p>
